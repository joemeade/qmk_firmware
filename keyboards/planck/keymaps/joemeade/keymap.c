...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY_LAYER] = LAYOUT_planck_grid_wrapper(
    ...
    GUI_L,   HYPER_L, KC_LALT, KC_LGUI, LOWER,  NAV_ENT, KC_SPC,  RAISE,   KC_RGUI, KC_RALT, HYPER_R, GUI_R
  ),
  ...
  [RAISE_LAYER] = LAYOUT_planck_grid_wrapper(
    KC_GRV,  _________________RAISE_L1__________________, _________________RAISE_R1__________________, KC_HASH,
  ...
  [NAV_LAYER] = LAYOUT_planck_grid_wrapper(
    ...
    _______, _______, _______, _______, XXXXXXX, LEADER,  _______, XXXXXXX, _______, _______, _______, _______
  ),
